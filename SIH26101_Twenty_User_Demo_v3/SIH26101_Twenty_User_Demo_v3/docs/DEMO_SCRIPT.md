...
The schema and engine contracts below are retained from v2. Consult DATA_OVERVIEW.md for current 20-user inventory, course limitations and new fixtures. Use backend/validate_v3.py for validation. Any v2 inventory totals below are historical.
