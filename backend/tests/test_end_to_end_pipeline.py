...
def test_full_pipeline_journey():
    ...
    # (only scripts/ingest_transcripts.py rebuilds it). Original module state is
    # restored on exit via the context manager below, so later live-path tests keep
    # the semantic-grounding stage active.
