...
AI_GENERATED_NOTICE = (
    "This practice quiz was freshly generated by the AI Learning Copilot from this lesson's approved transcript. "
    "Practice reinforces your understanding with instant feedback. Practice results never alter your official competency level."
)
STANDARD_NOTICE = (
    "Practice reinforces your understanding with instant feedback. "
    "Practice results never alter your official competency level."
)
...
def get_practice_quiz_for_lesson(lesson_id: str, current_user: Dict[str, Any] = Depends(get_current_user)):
    """
...
def submit_practice_quiz(
    ...
    try:
        ...
        return PracticeSubmissionResponse(
            ...
            results=results,
            notice="This practice result helps personalize your learning. It does NOT change your official proficiency level.",
